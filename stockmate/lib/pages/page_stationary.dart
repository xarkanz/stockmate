...
class PageStationary extends StatefulWidget {
  const PageStationary({super.key});

  @override
  State<PageStationary> createState() => _PageStationaryState();
}

class _PageStationaryState extends State<PageStationary> {
  @override
                      ...
                      Column(
                        ...
                        children: [
                          BoxCategories(
                            ...
                            box_text1_categories: "Sarasa",
                            box_text2_categories: "Colored Pen",
                            box_text3_categories: "12/03/2024",
                            box_border_categories: stationary,
                            categoriesTile: TileStationary(),
                          ),
                        ],
                      ),
                    ],

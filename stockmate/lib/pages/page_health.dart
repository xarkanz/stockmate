...
class PageHealth extends StatefulWidget {
  ...
  @override
  State<PageHealth> createState() => _PageHealthState();
}
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          BoxCategories(
                            box_image_categories: "assets/images/health.jpeg",
                            box_text1_categories: "Emina",
                            box_text2_categories: "Skincare",
                            box_text3_categories: "12/03/2024",
                            box_border_categories: health,
                            categoriesTile: TileHealth(),
                          ),
                        ],
                      ),
                    ],
